...
public class UpdateStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("UPDATE AND DELETE STUDENTS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select *from student_data where mobile_number='" + mobile_number + "'");

            if (rs.next()) { //if(rs.first()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String address = jTextField6.getText().toUpperCase();
        String college_name = jTextField7.getText().toUpperCase();
        String addhar_number = jTextField8.getText();
        String room_number = jTextField9.getText();
        String status = (String) jComboBox1.getSelectedItem();
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            if (status.equals("living")) {
                st.executeUpdate("update student_data set status='Booked' where room_number='" + room_number + "'");
            } else {
                st.executeUpdate("update student_data set status='Not Booked' where room_number='" + room_number + "'");
            }
            PreparedStatement ps = con.prepareStatement("update student_data set name=?,father_name=?,mother_name=?,e_mail=?,address=?,college_name=?,addhar_number=?,status=? where mobile_number=?");
            ps.setString(1, name);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Statement st = con.createStatement();
            st.executeUpdate("delete from student_data where mobile_number='" + mobile_number + "'");
            st.executeUpdate("update student_data set status='Not Booked' where room_number='" + room_number + "'");
