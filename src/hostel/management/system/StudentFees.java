...
public class StudentFees extends javax.swing.JFrame {
    ...
    public void tableDetails() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select *from student_fees where mobile_number='" + mobile_number + "'");
            while (rs.next()) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("select *from student_data where mobile_number='" + mobile_number + "' and status='Living'");
            if (rs.next()) {
            ...
            tableDetails();
            ResultSet rs1 = st.executeQuery("select *from student_fees inner join student_data "
                    + "where student_data.status='Living' and student_fees.month='" + month + "' "
                    + "and student_fees.mobile_number='" + mobile_number + "'");
            if (rs1.next()) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("insert into student_fees(mobile_number,month,amount) values(?,?,?)");
