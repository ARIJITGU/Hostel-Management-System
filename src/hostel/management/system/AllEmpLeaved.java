 ...
 * @author ARIJIT
 */
public class AllEmpLeaved extends javax.swing.JFrame {
    ...
    public AllEmpLeaved() {
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("SELECT *FROM EMP WHERE status='Not Working'");
            while(rs.next())
            {
    ...
    private void initComponents() {
        ...
        setTitle("ALL EMPLOYEE LEAVED THE HOSTEL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllEmpLeaved.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllEmpLeaved().setVisible(true);
            }
        });
    }
